...
var model = {
  ...
  fileFromBin: function (bin) {
    ...
    var data = {
      panel: binPanels.reduce(createPanelObj, {}),
      output: binPanels.reduce(createOutputObj, {})
    };
